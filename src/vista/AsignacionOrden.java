...
public class AsignacionOrden extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/iconoespecial.jpg"))); // NOI18N
        ...
        switch (respuesta) {
            case JOptionPane.YES_OPTION:
                try {
                    ...
                    ora2.regisData(sql);
                    sql=" Update ordenes set estado='Creada' where COD_ORDENES='"+codOrd+"'";
                ora2.regisData(sql);
